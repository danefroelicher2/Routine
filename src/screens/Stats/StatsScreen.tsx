...
export default function StatsScreen() {
  ...
  const calculateStreaks = async (userId: string) => {
    try {
      // SIMPLIFIED: Let's use the same logic as the loadStatsData function that works for calendar
      // Get all completion dates first and use simple completion-based streaks for now
